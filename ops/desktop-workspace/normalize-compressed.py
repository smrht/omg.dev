...
h=pathlib.Path.home();old=h/'.local/lib/omg-private/current';build=h/'.cache/agent-tmp/omg-desktop-1024';files=json.loads((old/'manifest.json').read_text())['files'];count=0
