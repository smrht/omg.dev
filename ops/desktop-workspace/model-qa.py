...
try:
 d.set_window_size(1619,1061);delta=d.execute_script("return outerHeight-innerHeight");d.set_window_size(1619,971+delta);d.get(args.url)
 ...
 visible('[data-rail-sid]')[0].click();screenshot('desktop-selected.png')
