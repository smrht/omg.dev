...
h=pathlib.Path.home();old=h/'.local/lib/omg-private/current';build=h/'.cache/agent-tmp/omg-chat-overview';files=json.loads((old/'manifest.json').read_text())['files'];count=0
